      ...
      <div className='flex items-center gap-4 '>
        {
          token && userData
            ? <div className='flex items-center gap-2 cursor-pointer group relative'>
              <img className='w-8 rounded-full border-2 border-transparent group-hover:border-primary transition-all duration-300' src={userData.image} alt="" />
            ...
            : <button onClick={() => navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block hover:scale-105 hover:bg-[#4F5CE6] transition-all duration-300 shadow-md'>Create account</button>
        }
        <img onClick={() => setShowMenu(true)} className='w-6 md:hidden cursor-pointer hover:scale-110 transition-transform' src={assets.menu_icon} alt="" />
